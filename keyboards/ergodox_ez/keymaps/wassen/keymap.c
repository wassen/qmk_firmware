...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,        KC_Z,         KC_X,           KC_C, KC_V,   KC_B,   M(HYPER),
        ...
        // right hand
             ...
             M(META),     KC_N,   KC_M,    KC_COMM, KC_DOT,  CTL_T(KC_SLSH),    KC_RSFT,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_AMPR, KC_KP_1,   KC_KP_2,    KC_KP_3,    KC_BSLS, KC_TRNS,
                         KC_KP_0,   KC_KP_0,    KC_DOT,     KC_EQL,  KC_TRNS,
       RGB_TOG, RGB_SLD,
       KC_TRNS,
...
[MDIA] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       KC_TRNS,  KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_TRNS, KC_TRNS,
                          KC_MPLY, KC_TRNS, KC_MUTE, KC_TRNS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt)
{
  ...
  switch(id) {
    ...
    case HYPER:
      if (record->event.pressed) {
        return MACRO(D(LCTL) ,D(LSFT), D(LALT), D(LGUI), END);
      }
      else {
    ...
    case META:
      if (record->event.pressed) {
        return MACRO(D(LCTL) ,D(LSFT), D(LALT), END);
      }
      else {
        return MACRO(U(LCTL) ,U(LSFT), U(LALT), END);
      }
      break;
  }
  return MACRO_NONE;
